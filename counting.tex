...
\begin{abstract}
    Let $G$ be a general linear group over or a unitary group. In this paper, we provide a precise description of the number of irreducible Casselman-Wallach representations of $G$ with a given infinitesimal character and associated variety, expressed in terms of painted Young diagrams.
\end{abstract}
